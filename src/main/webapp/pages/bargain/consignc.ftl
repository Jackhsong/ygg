...
<html>
	...
	<body>
		<div class="page">
			...
			<#if addressList?exists && (addressList?size>0) >
				 <#list  addressList as al >
						   <a href="${rc.contextPath}/bargain_ad/selectedads/${(al.addressId)!"0"}/${(ordertype)!"1"}" >
										<div class="list">
											<ul class="fl">
	    ...
	    <form id="form1" name="form1" action="${rc.contextPath}/bargain_ad/listadsmgr" method="post">
