...
<div class="down">
    <a href="http://download.gegejia.com" class="mdown"><img src="${rc.contextPath}/pages/images/lotteryImage/dowm.jpg" alt="下载心动慈露"/></a>
</div>
...
<input type="hidden" value=${lotteryId?c} id="lotteryId" />
   <div class="box1" id="box1">
       ...
       <div class="foot"><span>心动慈露：进口食品免税店</span></div>
   </div>
   ...
   <div class="box2" id="box2" style="display:none">
       ...
       <div class="play_box btn">
           ...
           <p class="share_text">使用此手机号码注册登录心动慈露即可查看优惠券</p>
       </div>
       <div class="foot"><span>心动慈露：进口食品免税店</span></div>
   </div>
