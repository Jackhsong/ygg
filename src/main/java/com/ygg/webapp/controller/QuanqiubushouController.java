        ...
        try
        {
            ...
            if (msgType.equals("event"))
            {
                if (event.equals("subscribe"))
                {
                    ...
                    str.append("<Articles>");
                    str.append("<item>");
                    str.append("<Title><![CDATA[心动慈露-带你吃遍全球！点击进入>>>]]></Title>");
                    // str.append("<Description><![CDATA[Hi！
                    // 欢迎加入心动慈露，同时恭喜您成为心动慈露的预备行动派，您只需点击环球美食购买任意美食，即可成为行动派，分享专属二维码，积累粉丝，赢丰厚奖金。详细模式点击查看。]]></Description>");
                    ...
                    sb.append("Hi！ 欢迎加入心动慈露，同时恭喜您成为心动慈露的预备行动派，您只需点击");
                    sb.append("<a href=\"" + index_url + "\">环球美食</a>");
                    sb.append("购买任意美食，即可成为行动派，分享专属二维码，积累粉丝，赢丰厚奖金。").append("\n\n");
                    // sb.append("<a href=\"" + index_url2 + "\">点击查看</a>");
                    // sb.append("。");
                    sb.append("<a href=\"" + url1 + "\">1、了解心动慈露。</a>").append("\n\n");
                    sb.append("<a href=\"" + url2 + "\">2、了解行动派模式。</a>").append("\n\n");
                    ...
                    if (id == CommonConstant.ID_NOT_EXIST)
                    {
                        ...
                        if (userInfo != null)
                        {
                            ...
                            sb.append(nickname + "通过二维码关注了本公众号，成为您的心动慈露直接粉丝！").append("\n");
                            ...
                            if (!fatherAccountId.equals("0"))
                            {
                                ...
                                sb.delete(0, sb.length());
                                sb.append(nickname + "通过关注您的直接粉丝：" + ae.getNickname() + "，成为您的心动慈露间接粉丝！").append("\n");
                            ...
                            if (!grandAccountId.equals("0"))
                            {
                                ...
                                sb.delete(0, sb.length());
                                sb.append(nickname + "通过关注您的间接粉丝：" + ae.getNickname() + "，成为您的心动慈露间接粉丝！").append("\n");
                                j = CommonHttpClient.messageCustomSend(token, ae1.getName(), sb.toString());
