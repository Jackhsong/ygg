		...
		<div class="page">
           ...
           <#if addressId?exists && addressId!='' &&addressId !='-1' >
			...
			<#assign cutPrice = point?number/100 />
				...
				微信支付<span>+行动币抵扣(可抵扣<span id="cutPrice">${cutPrice}</span>元)</span>
			...
			<div class="pay clear">
				<ul>
					<li>微信支付</li>
					<li><input  name="point2cash" type="checkbox" value="${cutPrice}" totalPrice="${allTotalPrice}" point="${point}" id="point2cash"/>
					行动币抵现
