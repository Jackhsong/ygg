...
public class CommonHttpClient
{
    ...
    // 发送图文客服消息（单图文）
    public static JSONObject articleMessageCustomSend(String token, String openId, JSONArray articleList)
    {
    	JSONObject parameters  = new JSONObject();
    	...
    	parameters.put("news", articles);
    	JSONObject j = (JSONObject)CommonHttpClient.commonHTTP2("https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=" + token, parameters);
    	
    	logger.info("向用户推送图文消息" + j.toJSONString());
    ...
    public static void main(String[] args)
    {
        ...
        sb.append("购买任意美食，即可成为行动派，分享专属二维码，积累粉丝，赢丰厚奖金。详细模式");
