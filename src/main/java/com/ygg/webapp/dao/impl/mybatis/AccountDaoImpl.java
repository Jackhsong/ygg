...
public class AccountDaoImpl extends BaseDaoImpl implements AccountDao
{
    ...
    @Override
    public Map<String, Object> getPoint(Map<String, Object> para)
            throws DaoException{
        return getSqlSession().selectOne("AccountMapper.getPoint", para);

    }
    
    @Override  
    public  int addPoint(int accountId, int point,int orderId)
            throws DaoException{
        Map<String, Object> para = new HashMap<String, Object>();
        ...
        return getSqlSession().insert("AccountMapper.addPoint", para);

   }    
    @Override  
    public  int usePoint(int accountId, int point,int orderId)
            throws DaoException{
        Map<String, Object> para = new HashMap<String, Object>();
        para.put("accountId", accountId);
        para.put("point", point);
        ...
        return getSqlSession().insert("AccountMapper.usePoint", para);

   }        
    
    @Override  
    public  int activatePoint(int orderId)
            throws DaoException{

        return getSqlSession().update("AccountMapper.activatePoint", orderId);

   }  
    @Override  
    public  int getPointOfOrder(int orderId)
            throws DaoException{

        return getSqlSession().selectOne("AccountMapper.getPointOfOrder", orderId);

   }      
    public int deletePointOrder(int orderId)throws DaoException{
        return getSqlSession().selectOne("AccountMapper.deletePointOrder", orderId);
    }
}
