...
<input type="hidden" value=${gameId?c} id="gameId" />
    <div class="mheader"><a href="http://download.gegejia.com" class="mdown"><img src="${rc.contextPath}/pages/images/spead/1.jpg" alt="下载心动慈露"/></a></div>
    ...
    <div class="mbox1" id="mbox1">
        <div style="text-align:center;">领取心动慈露${info}</div>
    ...
    <div class="mbox1 mbox2" id="mbox2">
        ...
        <p>请下载心动慈露APP后</p>
        <p>使用此手机号注册登陆后查看</p>
        <a class="mbtn" href="http://download.gegejia.com">下载心动慈露APP</a>
    </div>
   ...
   <dl class="mtext">
        ...
        <dd>2、下载心动慈露APP，使用输入的手机号注册并登陆；</dd>
