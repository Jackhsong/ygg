		...
		<div class="pagea">
            <#if productList?exists && (productList?size<= 0) >
			     ...
			     <div class="emptyadd">
			      ...
			      <!-- 空购物车显示 End-->
            <#else>
			<div class="cnotice"><img src="${rc.contextPath}/pages/images/buytime.png"><em>请在<span id="carttime"><span class="minute"></span><span class="second"></span></span>内提交订单，时间结束后商品可能被抢完。</em></div>
