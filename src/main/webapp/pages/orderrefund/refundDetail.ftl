...
<head>
	...
	<title>心动慈露</title>
	<meta name="keyword" content="心动慈露" >
...
<body>
	...
	<#if refundProductInfo ??>
	    <#if refundProductInfo.status==1>
		    <section class="refund-tips"><div id="clockbox1">已收到您的申请，心动慈露将在<span class="time"><span class="hour"></span><span class="minute"></span><span class="second"></span></span>内为您处理。</div></section>
		 ...
		 <#elseif refundProductInfo.status==3>
		     <section class="refund-tips"><div id="clockbox2">退款申请已通过，心动慈露将在<span class="time"><span class="hour"></span><span class="minute"></span><span class="second"></span></span>内将款项打入您的账户。</div></section>
		     <script type="text/javascript">
					$(function(){
						var stime="${endSecond!"0"}" ;
						var sid="#clockbox2";
		 ...
		 <#elseif refundProductInfo.status==4>
		     <section class="refund-tips done">退款成功，款项已打入您的账户，如有疑问，请随时与心动慈露客服联系：）</section>
		 <#elseif refundProductInfo.status==5>
		    <section class="refund-tips done">退款关闭，感谢您对心动慈露的信任和支持：）</section>
		 <#else>
		 </#if>
    </#if>
