...
public class CommonActivityController
{
        ...
        throws Exception
    {
        ...
        // /// 缓存页面
        mappage = this.cacheService.getCache(CacheConstant.PAGE_COMMON_ACTIVITY_PRODUCT_CACHE);
        // ///////////////////////////////////////////////////////////////////
        ...
        if (null != result && !result.equals(""))
        {
            ...
            if (status.equals(CommonEnum.BUSINESS_RESPONSE_STATUS.SUCCEED.getValue()))
            {
                ...
                if (productIdList != null) // / 通过ID去查商品详情
                {
                    ...
                    String resultDetail = this.resourceService.commonActivitiesDetail("{'productIdList':" + productListJson + "}", type); // {'productIdList':[1,2]}
