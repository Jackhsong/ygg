...
public class AddressServiceImpl implements AddressService
{
    ...
    @Override
    public ReceiveAddressView findDefaultAddressViewByAccountId(String accountId)
            throws Exception
            {
        ...
        if (rae == null)
            return null;
        ReceiveAddressView av = new ReceiveAddressView();
        
        av.setAccountId(Integer.valueOf(accountID));
        av.setId(rae.getId());
        av.setCity(rae.getCity());
        av.setDetailAddress(rae.getDetailAddress());
        av.setDistrict(rae.getDistrict());
