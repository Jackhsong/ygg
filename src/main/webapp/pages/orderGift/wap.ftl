        ...
        <div class="relative">
            <dl class="abso box userInfo">
                ...
                <dd class="fl relative paopaoWrap">
                    ...
                    <p class="paopaoWord abso">我刚刚在心动慈露全球美食买了一堆好吃的，还领到了<i id="totalNo"></i>个红包，分享给你，快来领取吧！</p>
                </dd>
            </dl>
        ...
        <div class="relative packet">
            ...
            <section class="phone abso hidden">
                ...
                <div class="relative">
                    ...
                    <p class="phoneTips abso">现金券将放入心动慈露账户:<i class="updatePhone"></i> <b class="updateBtn">修改 ></b></p>
