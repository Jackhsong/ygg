...
/*****底部导航****/
		...
		#footBar { width: 100%; position:fixed; top:20; background: #fff;  margin:0 auto;border-top:solid 1px #e5e5e5; z-index:100000; }
...
<span  id="showCartCount4" name="showCartCount4"></span>
 <div id="footBar">
		...
		</a><a href="${rc.contextPath}/selftestcontroller/getList#wechat_redirect">
			<div class="star"></div>
