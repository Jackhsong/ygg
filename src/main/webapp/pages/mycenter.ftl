...
<html>
	...
	<body>
		<div class="page">
			...
			<a href="${rc.contextPath}/orderrefund/orderRefundIndex"><div class="listb"><img src="${rc.contextPath}/pages/images/contact.png" />联系心动慈露</span></div></a>
			<a href="http://static.gegejia.com/custom/about_gegejia.html"><div class="listc"><img src="${rc.contextPath}/pages/images/about.png" />关于心动慈露</div></a>
