		...
		<div class="page">
			...
			<form id="form1" name="form1"  method="post">
				<ul class="reg_frame">
					...
					<li class="verify"><img src="${rc.contextPath}/pages/images/msg.png"><input type="tel" value="请输入短信验证码" name="smsverify" id="vfy" maxlength="6"/><a class="verify_a" href="javascript:void(0)">获取验证码</a>
				...
				<a href="javascript:void(0)" id="userresetpwd"><p class="login">找回密码</p></a>	
