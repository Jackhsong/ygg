...
public class HqbsFansOrderDaoImpl extends BaseDaoImpl implements HqbsFansOrderDao {
	...
	public int insertFans(QqbsFansOrderEntity qro)throws DaoException{
	 ...
	 /**
		 ...
		 */
		@Override
		public int updateStatus(int fansOrderId, int fansAccountId,byte status) {
			Map<String, Object> map = new HashMap<String, Object>();
	        map.put("fansOrderId", fansOrderId);
	        map.put("fansAccountId", fansAccountId);
	        map.put("status", status);
	        return this.getSqlSession().update("HqbsFansOrderMapper.updateStatus", map);
		}
