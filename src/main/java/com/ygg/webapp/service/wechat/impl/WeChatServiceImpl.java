...
//            logger.info("扫码关注人用户信息：" + userInfo);
            ...
            nickname = (nickname == null || "".equals(nickname)) ? "心动慈露用户" : nickname;
...
//                qae.setExStatus(1);
        ...
        throws Exception
    {
        ...
        if (oneFans != null)
        {
            ...
            // 发送消息
//            String one = accountEntity.getNickname() + "通过您的邀请关注了本公众号，成为您的心动慈露直接粉丝!";
...
//            CommonHttpClient.messageCustomSend(WeixinMessageDigestUtil.getAccessToken(appid, secret), oneFans.getOpenId(), one);
            ...
            if (oneFans.getFatherAccountId() != 0)
            {
                ...
                if (secondFans != null)
                {
                    ...
                    // 发送消息
//                    String two = accountEntity.getNickname() + "通过关注您的直接粉丝：" + oneFans.getNickName() + "，成为您的心动慈露间接粉丝";
                    String two = "您管理的行动派/粉丝: "+ oneFans.getNickName() + " 新增粉丝: " +accountEntity.getNickname();
                    // Token openId
...
//                            hqbsFansDao.insertFans(tfe);
                            // 发送消息
//                            String third = accountEntity.getNickname() + "通过关注您的间接粉丝：" + oneFans.getNickName() + "，成为您的心动慈露间接粉丝";
//                            String third = "您管理的行动派/粉丝: "+ oneFans.getNickName() + " 新增粉丝: " +accountEntity.getNickname();
                            // Token openId
