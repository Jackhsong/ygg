...
public interface AccountDao
{
    ...
    Map<String, Object> getPoint(Map<String, Object> para)
            throws DaoException;
    ...
    public int activatePoint(int OrderId)throws DaoException;
    public int getPointOfOrder(int OrderId)throws DaoException;
