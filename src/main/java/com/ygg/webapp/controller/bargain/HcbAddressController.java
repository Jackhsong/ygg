 ...
 */
@Controller
@RequestMapping("/bargain_ad")
public class HcbAddressController
{
    
    Logger logger = Logger.getLogger(HcbAddressController.class);
        ...
        throws Exception
    {
        ...
        mv.setViewName("bargain/consignee");
        ...
        throws Exception
    {
        ...
        ModelAndView mv = new ModelAndView();
        mv.setViewName("bargain/consigneecart");
        AccountView av = SessionUtil.getCurrentUser(request.getSession());
        if (av == null)
        {
            mv.addObject("islogin", CommonEnum.COMMON_IS.NO.getValue());
    ...
    {
        ModelAndView mv = new ModelAndView();
        mv.setViewName("bargain/consignc");
        AccountView av = SessionUtil.getCurrentUser(request.getSession());
        if (av == null)
        {
            mv.addObject("islogin", CommonEnum.COMMON_IS.NO.getValue());
        ...
        throws Exception
    {
        ...
        mv.setViewName("bargain/consignadd");
        ...
        throws Exception
    {
        ...
        mv.setViewName("bargain/consigncartadd");
        List<ProvinceView> pves = this.cacheService.getCache(CacheConstant.PROVINCE_DATA_CACHE);
        Map<String, Object> citiesMap = this.cacheService.getCache(CacheConstant.CITY_DATA_CACHE);
        Map<String, Object> districtsMap = this.cacheService.getCache(CacheConstant.DISTRICT_DATA_CACHE);
        if (pves == null || pves.isEmpty())
    ...
    {
        ModelAndView mv = new ModelAndView();
        mv.setViewName("forward:/bargain_ad/toaddads"); // / 出错留在此页面
        ...
        mv.setViewName("redirect:/bargain_ad/listads"); // / 成功跳到地址管理中心
        return mv;
    }
    ...
    {
        ModelAndView mv = new ModelAndView();
        String errorViewName = "forward:/bargain_ad/toorderaddads/" + ordertype + "/" + isBonded;
        ...
        mv.setViewName("redirect:/bargain/create_order"); // 成功
        if (source != null && source.equals("consignc"))
        {
            mv.setViewName("forward:/bargain_ad/listadsmgr"); // 成功
            mv.addObject("ordertype", ordertype);
            mv.addObject("isBonded", isBonded);
        ...
        throws Exception
    {
        ...
        {
            mv.setViewName("redirect:/bargain_ad/listadsmgr"); // 是从定单中来的
            mv.addObject("ordertype", ordertype);
            mv.addObject("isBonded", isBonded);
            mv.addObject("source", "consignc");
        }
        ...
        if (null != result && !result.equals(""))
        {
            ...
            if (status.equals(CommonEnum.BUSINESS_RESPONSE_STATUS.FAILED.getValue()))
            {
                ...
                String viewName = "forward:/bargain_ad/tomdfads/" + addressId + "/" + accountId; // 出错留在此页面
    ...
    {
        ModelAndView mv = new ModelAndView();
        mv.setViewName("bargain/consigncartmdf");
        ...
        if (av == null)
        {
            ...
            mv.setViewName("redirect:/bargain/create_order");
            return mv;
        }
    ...
    {
        ModelAndView mv = new ModelAndView();
        mv.setViewName("bargain/consignmodify");
    ...
    {
        ModelAndView mv = new ModelAndView();
        String viewName = "forward:/bargain_ad/toordermdfads/" + address.getAddressId() + "/" + ordertype + "/" + isBonded;
        ...
        throws Exception
    {
        ...
        String viewName = "forward:/bargain_ad/tomdfads/" + address.getAddressId() + "/" + address.getAccountId(); // 出错返回的视图
        String validateResult = address.validate("");
        if (!validateResult.equals("SUCCESS"))
        {
