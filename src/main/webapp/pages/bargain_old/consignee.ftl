		...
		<div class="page">
			<div class="tit">
				...
				<#if (Session.yggwebapp_current_user_key.id?c)?exists>
				   <a href="${rc.contextPath}/bargain_ad/toaddads" class="reg tit_ra">新增</a>
				</#if>
			</div>
			<div class="conframe">
			 ...
			 <#list  addressList as al >
					                <a href="${rc.contextPath}/bargain_ad/tomdfads/${al.addressId?default("0")}/${(Session.yggwebapp_current_user_key.id?c)!"-1"}">
										<div class="list">
											<ul class="fl">
				  ...
				  <#else>                       <!-- 为空时显示此 -->
					       <div class="emptyadd">
							...
							<p>收货地址为空</p>
							<a href="${rc.contextPath}/bargain_ad/toaddads">新增地址</a>
						  </div>   
				  </#if>
			<#else>
			     <div class="emptyadd">
