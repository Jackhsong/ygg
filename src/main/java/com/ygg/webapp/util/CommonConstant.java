...
public class CommonConstant
{
     ...
     * 平台短信提示语
     */
    public static final String SMS_CONTENT = "【心动慈露】短信验证码:";
    
    public static String getSendRegisterSMSContent(String sendRandomCode)
    {
        return "【慈露行动派】验证码" + sendRandomCode + "，您正在注册慈露行动派账号，验证码10分钟内有效。千万不要说出去哦！";
    }
    
    public static String getSendResetSMSContent(String sendRandomCode)
    {
        return "【慈露行动派】验证码" + sendRandomCode + "，您正在找回密码，验证码10分钟内有效。千万不要说出去哦！";
    }
    ...
    /**默认分享文案标题*/
    public static final String DEFAULT_SHARETITLE = "心动慈露：祝贺你成为心动者";
    /** 默认分享文案内容*/
    public static final String DEFAULT_SHARECONTENT = "心动者升级为行动派，就能一边分享一边赚钱啦！";
